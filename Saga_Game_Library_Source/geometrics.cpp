...
Geometrics::Geometrics(): Geometrics(1, Color(0, 0, 0), Color(255, 255, 255)) {}
Geometrics::Geometrics(int thickness, const Color& lineColor, const Color& fillColor):
	thickness(thickness), lineColor(lineColor), fillColor(fillColor) {}
...
void Geometrics::drawTriangle(
	...
	if(fill) al_draw_filled_triangle(x1, y1, x2, y2, x3, y3, fillColor);
}
...
void Geometrics::drawEllipse(float cx, float cy, float rx, float ry, bool fill) const {
