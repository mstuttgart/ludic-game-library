...
Font::Font( const String& fileName, unsigned int fontSize ) :
	...
	if( !load( fileName, fontSize ) )
		throw Ludic::Exception( "Error to load Font" );
...
CollisionBox Font::getTextDimension( const String& str ) {
	...
	return CollisionBox( Vector2D( x, y ), w, h );

}

//////////////////////////////////////////////////////////////

CollisionBox Font::getTextDimension() {
